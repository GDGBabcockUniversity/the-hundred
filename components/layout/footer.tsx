...
const SOCIAL_COLORS: Record<string, string> = {
  ...
  instagram: "bg-[#E4405F] hover:bg-[#E4405F]/80",
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-sm text-white/60">Babcock University</p>
            <Image
              ...
              <div className="flex gap-3">
                {SOCIAL_LINKS.map((social) => (
                  <a
                    ...
                    className={`inline-flex size-9 items-center justify-center rounded-full text-white transition-opacity ${SOCIAL_COLORS[social.icon] ?? "bg-white/20"}`}
          ...
          {/* Spacer for rope graphic area on desktop */}
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <p className="text-center text-xs text-white/40">
            © {new Date().getFullYear()} GDG on Campus Babcock. All rights
            reserved.
          </p>
        </div>
      </div>
